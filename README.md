![Logo](admin/images/oura-banner.webp)

# ioBroker.oura

[![NPM version](https://img.shields.io/npm/v/iobroker.oura.svg)](https://www.npmjs.com/package/iobroker.oura)
[![Downloads](https://img.shields.io/npm/dm/iobroker.oura.svg)](https://www.npmjs.com/package/iobroker.oura)
![Number of Installations](https://iobroker.live/badges/oura-installed.svg)
![Current version in stable repository](https://iobroker.live/badges/oura-stable.svg)
[![Dependency Status](https://img.shields.io/david/Acgua/iobroker.oura.svg)](https://david-dm.org/Acgua/iobroker.oura)

[![NPM](https://nodei.co/npm/iobroker.oura.png?downloads=true)](https://nodei.co/npm/iobroker.oura/)

**Tests:** ![Test and Release](https://github.com/Acgua/ioBroker.oura/workflows/Test%20and%20Release/badge.svg)

## Oura Ring – Adapter for ioBroker
